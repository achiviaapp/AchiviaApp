...
<div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed ">
    ...
    <div class="kt-header__topbar w-100">
        <div class="kt-header__topbar-item w-100">
            <div class="kt-header__topbar-wrapper w-100">
                <h3 id="app-name" class="kt-header__title kt-grid__item text-center kt-header__topbar-icon kt-header__topbar-icon--success w-100">
                    Achivia App
                </h3>
            </div>
        </div>
