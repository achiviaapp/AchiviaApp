...
<head>
    ...
    <!--end:: Vendor Plugins -->
    <link href="{{url('web/css/style.bundle.css')}}" rel="stylesheet" type="text/css" />

    <!-- Custom Edit on css -->
    <link href="{{url('web/css/style.css')}}" rel="stylesheet" type="text/css" />

    <!--begin:: Vendor Plugins for custom pages -->
    <link href="{{url('assets/plugins/custom/jquery-ui/jquery-ui.bundle.css')}}" rel="stylesheet" type="text/css" />
